...
export default function Footer() {
  return (
    <footer className="bg-surface text-muted border-t border-border">
      <div className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="grid gap-10 md:grid-cols-4 items-start">
          ...
          {/* ================= TEAM ================= */}
          <div>
            <h4 className="text-sm font-semibold text-text mb-4">Team</h4>
          ...
          {/* ================= LOCATION ================= */}
          <div>
            <h4 className="text-sm font-semibold text-text mb-4">Location</h4>
            ...
            <p className="mt-3 text-sm flex items-center gap-2 text-text">
