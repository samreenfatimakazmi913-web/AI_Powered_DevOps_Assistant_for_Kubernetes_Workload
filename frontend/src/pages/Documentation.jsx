...
export default function Documentation() {
  ...
  // Pass active state to sidebar
  useEffect(() => {
    window.dispatchEvent(new CustomEvent("docSectionChange", { detail: activeSection }));
  }, [activeSection]);
  ...
  return (
    <div className="bg-white text-black">
      ...
      <div className="flex">
        ...
        {/* CONTENT */}
        <main className="flex-1 px-10 py-16 space-y-32 max-w-4xl mt-[72px]">
