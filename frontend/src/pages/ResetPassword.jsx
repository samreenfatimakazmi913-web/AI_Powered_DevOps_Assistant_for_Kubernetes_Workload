...
export default function ResetPassword() {
  ...
  const submit = async e => {
    ...
    try {
      ...
      if (res.ok) {
        alert(
          data.emailSent === false && data.emailError
            ? `Password updated successfully, but the confirmation email could not be sent.\n\n${data.emailError}`
    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <div className="w-14 h-[3px] bg-[#6366f1] mx-auto mt-3" />
